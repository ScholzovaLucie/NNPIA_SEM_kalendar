...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Query("SELECT e FROM Event e where e.user.id = :id and e.date = :date and e.typ = :typ")
    List<Event> getAllByDateAndType(@Param("id") Long id, @Param("date") LocalDate date, @Param("date") TypEvent typ);
